              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className='flex'>
                    ...
                    <div className='lg:flex gap-2 hidden border rounded-lg border-gray-700 p-1 items-center'>
                      <Button className='bg-green-600 text-white text-[10px] border-none rounded-lg px-3 py-1  hover:bg-green-700' >
                        Deliver Now
                      </Button>

                      <Button style={{borderLeft: '1px solid #6F6F6F'}} className='text-[10px] border-none rounded-lg px-3 py-1 border-l-4 border-gray-500 border-solid rounded-none bg-transparent'>
                        Self Pickup
                      </Button>

                      <Button style={{borderLeft: '1px solid #6F6F6F'}} className='text-[10px] border-none rounded-lg px-3 py-1  border-l-4 border-red-500 border-solid rounded-none bg-transparent'>
                        schedule
                      </Button>
                    </div>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-tl-lg rounded-tr-lg text-sm font-medium whitespace-nowrap transition-colors ${
                      activeCategory === category
                        ? 'bg-[#222] text-white'
                        : 'font-thin text-gray-700 hover:bg-gray-200'
                    }`}
                  >
                    {category}
                  </button>
